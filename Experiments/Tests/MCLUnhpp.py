...
from ...Components.SamplePathNHPP import SamplePathNHPP
from ...Simulation.lowerUpper2 import simulate
...
def main():
    ...
    # NHPP inputs
    rates = eval(cp['nhpp']['rates'])
    times = eval(cp['nhpp']['times'])
    ...
    for i in range(N):
        ...
        omega = SamplePathNHPP(svca, rates, times, T, svcDist=sdist, mxwDist=svcDists)
