from ..Methods.sample import discreteN, discreteDict

class SamplePath():
    def __init__(self, svcArea, arrStream, svcDist):
        self.T = arrStream.T        
        self.svcDist = svcDist
        self.__buildCalls(arrStream)
        self.__buildQ(svcArea)
    
    def __buildCalls(self, arrStream):
        ...
        for t in xrange(self.T + 1):
            ...
            if callLoc != 'null':
                ...
                self.__calls[t]['svc'] = discreteDict(self.svcDist)
